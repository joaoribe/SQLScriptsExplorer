...
namespace SQLScriptsExplorer.Addin.Commands.ToolWindow
{
    ...
    internal sealed class MainToolWindowCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("00c595cc-9857-4264-8d37-09710a9af9cc");
        ...
        public MainToolWindowCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
